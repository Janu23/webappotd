...
<html>
  ...
  <span class="navbar-brand mb-0 h1">Definir trecho - Exportar Planilha Drenagem Superficial</span>
    </nav>
    <nav aria-label="breadcrumb bg-white">
    <ol class="breadcrumb bg-white">
         <li class="breadcrumb-item"><a href="index.php">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">Definir trecho - Exportar Planilha Drenagem Superficial</li>
    </ol>
    </nav>
        <div id="container-tabela">
            <form action="exportar_planilha_ds.php" method="post"> 
                <fieldset>
