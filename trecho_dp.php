...
<html>
  ...
  <span class="navbar-brand mb-0 h1">Definiir trecho -  Planilha Drenagem Profunda</span>
    </nav>
    <nav aria-label="breadcrumb bg-white">
    <ol class="breadcrumb bg-white">
         <li class="breadcrumb-item"><a href="index.php">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">Definir trecho - Planilha Drenagem Profunda</li>
    </ol>
    </nav>
        <div id="container-tabela">
            <form action="index_dp.php" method="post"> 
                <fieldset>
